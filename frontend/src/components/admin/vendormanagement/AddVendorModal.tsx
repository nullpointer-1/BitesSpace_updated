            ...
            <form onSubmit={onSubmit}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                ...
                <div className="flex items-center gap-2 mt-4 md:col-span-2">
                  <input
                    type="checkbox"
                    id="shopActive" // Renamed ID for clarity
                    checked={formData.active} // Maps to ShopDto.active
                ...
                {/* Vendor active status is implicitly linked to Shop's active status as per backend logic */}
                {/* If you need separate control, add a checkbox for vendorActive here and manage it */}
                {/* <div className="flex items-center gap-2 mt-4">
                  <input
                    type="checkbox"
                    id="vendorActive"
                    checked={formData.vendorActive}
                    onChange={(e) => setFormData({ ...formData, vendorActive: e.target.checked })}
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
                  <Label htmlFor="vendorActive">Vendor is Active</Label>
                </div>
                */}
